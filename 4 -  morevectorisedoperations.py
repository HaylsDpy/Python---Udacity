# Assume that 50% is male and 50% of female
# Change False to True for each block of code to see what it does

# Arithmetic operations between 2 NumPy array
if True:
   a = np.array([1, 2, 3, 4])
   b = np.array([1, 2, 1, 2])
...
# Arithmetic operations between a NumPy array and a scalar
if True:
   a = np.array([1, 2, 3, 4])
   b = 2
...
# Comparison operations between a NumPy array and a scalar
if True:
   a = np.array([1, 2, 3, 4])
   b = 2
